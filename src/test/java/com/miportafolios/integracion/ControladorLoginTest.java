package com.miportafolios.integracion;

import com.miportafolios.integracion.config.HibernateTestConfig;
import com.miportafolios.integracion.config.SpringWebTestConfig;
import com.miportafolios.dominio.Usuario;
...
public class ControladorLoginTest {
	...
	public void debeRetornarLaPaginaLoginCuandoSeNavegaALLogin() throws Exception {
		...
		assertThat(modelAndView.getModel().get("datosLogin").toString(),  containsString("com.miportafolios.presentacion.DatosLogin"));
